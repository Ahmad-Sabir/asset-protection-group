<x-app-layout>
    ...
    <div class="main-wrap" x-data="TaskData()">
        ...
        <div class="main-fixed-wrap">
            ...
            <div class="top-buttons gap-3">
                <a class="md:w-auto w-full" href="{{ route('admin.companies.company-work-orders.export.pdf', [$workOrder->company_id, $workOrder->id]) }}">
                    <x-button type="submit" class="btn-outline-secondary">
                        <em class="fa-solid fa-cloud-arrow-down"></em> Download PDF
                    </x-button>
                </a>
                <a class="md:w-auto w-full" href="{{ route('admin.companies.company-work-orders.export.csv', [$workOrder->company_id, $workOrder->id]) }}">
                   ...
                   <div class="main-wrapper">
                        <div class="sm:flex items-center">
                            ...
                            <div class="sm:ml-auto gray1">
                                <a href="{{ route('admin.companies.work-orders.edit', [$workOrder->company_id, $workOrder->id]) }}">Edit Details <em class="fa-solid fa-pen ml-2"></em></a>
                            </div>
                        </div>
                        ...
                        <div class="sm:flex items-center my-3">
                            ...
                            <div class="sm:ml-auto gray1">
                                ...
                                <div class="popover-box ml-2">
                                    ...
                                    <div class="popover-content">
                                        <div class="form-group">
                                            <x-input type="text" class="form-control w-full" id="log-input" placeholder="hh:mm:ss" name="work_order_log_timer" value="{{$workOrder->work_order_log_timer}}" style="font-size: larger;"></x-input>
                                        </div>
                                        <span id="log-time">
                                ...
                                <div>
                                    <table class="admin-table" aria-label="">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="border-b border-t">
                                                <td class="gray3">Assigned To:
                                                </td>
                                                <td class="text-right">
                                                    {{$workOrder->user?->full_name}}
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                ...
                                <div>
                                    <table class="admin-table" aria-label="">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="border-b border-t" x-show="workOrder.work_order_type == '{{ config('apg.work_order_type_check.recurring') }}'">
                                            ...
                                            <tr class="border-b border-t">
                                                <td class="gray3 w-48">Notes</td>
                                                <td class="text-right">
                                                    <div x-data="{ notes: false }">
                                                        <div class="relative overflow-hidden transition-all ease-out duration-300 break-word" x-bind:class="{'max-h-9999': notes, 'max-h-40': !notes}">
                                                            {!! nl2br(e($workOrder->additional_info)) !!}
                                                        </div>
                                                        <button type="button" class="primary mt-4" @click="notes = !notes">
                                                            <span x-text ="notes ? 'Read Less' : 'Read More'">
                                                        </button>
                                                    </div>
                                                </td>
                                            </tr>
    ...
    ?>
@include('custom-view-js', ['work_order_base_url' => route('admin.companies.work-orders.index',$workOrder->company_id)]);
</x-app-layout>
