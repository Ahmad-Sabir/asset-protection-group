    ...
    <!-- Content -->
      <div class="main-wrap" x-data="TaskData()">
        ...
        <div class="main-content">
            <form action="{{ route('admin.companies.work-orders.update', [
                    $company->id,
                    $workOrder->id,
                    'is_compliance' => request()->get('is_compliance')
                ]) }}" method="post" x-data="submitForm()" @submit.prevent="onSubmitPut" id="work-order-put-form">
                <div id="alpine_work_order" class="work-order-details-section"
                x-data="{ workOrder: {{json_encode($workOrder->only([
                    'id',
                    'assignee_user_id',
                    'asset_id',
                    'work_order_type',
                    ...
                    <div class="main-wrapper">
                        ...
                        <div class="sm:flex items-center my-3">
                            <div class="form-group">
                                ...
                                <select class="form-select form-select-green md:w-auto w-full" id= "status_order" name="work_order_status">
                            ...
                            <div class="form-group md:ml-3 ml-0" id="on_hold_reason" x-show="workOrder.work_order_status == '{{ config('apg.work_order_status.on_hold') }}'">
                                ...
                                <input type="text" class="form-control md:w-auto w-full" placeholder="Reason" id="hold_reason" name="on_hold_reason" value="{{$workOrder->on_hold_reason}}">
                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    >
                                                        ...
                                                        @forelse (config('apg.qualification') as $qualification)
                                                            <option @selected($qualification == $workOrder->qualification) value="{{$qualification}}">{{$qualification}}</option>
                                                        @empty
                                                        @endforelse
                                                    </x-select>
                                ...
                                <table class="admin-table" aria-label="">
                                    ...
                                    <tbody>
                                        <tr class="border-b border-t">
                                            ...
                                            <td class="text-right">
                                                <div class="form-group">
                                                    <x-select id="work_order_type" class="w-full"
                                                        x-model="workOrder.work_order_type"
                                ...
                                <template x-for="(task,index) in tasks" :key="index">
                                    <div class="flex justify-between border-b py-4">
                                        ...
                                        <div class="flex items-start ml-4">
                                            ...
                                            <a class="ml-2 gray1" @click.prevent="deleteData(task,index)"><em class="fa-solid fa-trash" aria-hidden="true"></em></a>
                                        </div>
                                    </div>
            ...
            <x-right-modal id="add-additional-task" heading="Add Task">
                <form action="{{ route('admin.work-orders.additional-task.store') }}" method="post" @submit.prevent="saveData" id="additional-task-post-form">
                    ...
                    <div class="form-group">
                        ...
                        <x-textarea id="task_detail" class="form-control" x-model="form.task_detail" name="task_detail"
                                    rows="4" cols="20"></x-textarea>
