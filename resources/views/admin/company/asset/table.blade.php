<div>
    ...
    <div class="advance-filters" x-data="{advance_filter:false, isLoading:false}">
        <div x-show="advance_filter" x-transition:enter.duration.600ms x-transition:leave.duration.500ms>
            ...
            <div class="grid grid-cols-2 gap-4 advance-filter-calander">
            ...
            <div class="grid grid-cols-3 gap-4 assets-range-bar">
            ...
            <div class="grid md:grid-cols-3 grid-cols-1 gap-2">
                ...
                <div>
                    ...
                    <div class="form-group grid grid-cols-3 gap-2">
                        <x-input type="number" class="mr-2" placeholder="Year" wire:model.defer="filter.remaining_useful_life.year"></x-input>
                        <x-input type="number" class="mr-2" placeholder="Month" wire:model.defer="filter.remaining_useful_life.month"></x-input>
                        <x-input type="number" placeholder="Day" wire:model.defer="filter.remaining_useful_life.day"></x-input>
                    </div>
                </div>
            </div>
            ...
            <div class="tab-pane fade show active" id="tabs-table" role="tabpanel" aria-labelledby="tabs-table-tab">
                ...
                <table class="admin-table" aria-label="">
                        ...
                        <tr>
                            ...
                            <th scope="col" class="id-width">
                                <a wire:click.prevent="sortBy('company_id')" role="button" href="#">
                                    Company Id
                                    @include('components._sort-icon', ['field' => 'company_id'])
                                </a>
                            </th>
                            <th scope="col">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $asset->number }}</td>
                            <td>{{ $asset->company_number }}</td>
                            <td>{{ $asset->name }}</td>
                            <td>{{ $asset->assetType?->name }}</td>
                            <td @class([ 's-active'=> $asset->status,
                            ...
                            <td>
                                <div class="table-icons">
                                    <x-nav-link title="View" href="{{ route('admin.companies.assets.show', [$asset->company->id, $asset->id]) }}">
                                        <em class="fa fa-eye" aria-hidden="true"></em>
                                    </x-nav-link>
                                    <x-nav-link title="Edit" href="{{ route('admin.companies.assets.edit', [$asset->company->id, $asset->id]) }}">
