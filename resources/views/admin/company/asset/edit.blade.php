        ...
        <div class="main-content">
            <div class="main-wrapper">
                <div class="admin-tabs">
                    ...
                    <form action="{{ route('admin.companies.assets.update', [$company->id, $asset->id]) }}" method="post" x-data="submitForm()" @submit.prevent="onSubmitPut" id="asset-put-form">
                                        ...
                                        <div>
                                            <div class="form-group">
                                                ...
                                                <x-input type="text" id="company_number" name="company_number" placeholder="Company ID"
                                                    x-bind:class="errorMessages.company_number ? 'invalid' : ''" value="{{ $asset->company_number }}">
                                                </x-input>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <x-date-picker id="warranty_expiry_date" name="warranty_expiry_date"
                                                    ...
                                                    value="{{ $asset->warranty_expiry_date ? customDateFormat($asset->warranty_expiry_date) : '' }}"
                                                    autocomplete="off" data-input>
                                                </x-date-picker>
