        ...
        <div class="main-content">
            <div class="main-wrapper">
                <div class="admin-tabs">
                    ...
                    <form action="{{ route('admin.work-orders.store', ['is_compliance' => $isCompliance ?? null]) }}" method="post" x-data="submitForm()" @submit.prevent="onSubmitPost" id="work-order-post-form">
                        <div class="tab-content" id="tabs-tabContent">
                            <div class="tab-pane fade show active" id="work-order-detail" role="tabpanel" aria-labelledby="work-order-detail-tab">
                                <div class="tab-content-wrapper">
                                    ...
                                    <div class="form-group">
                                        <x-label>Flag</x-label>
                                        <label for="flag">
                                            <x-input type="checkbox" id="flag" class="form-check-input hidden" name="flag" x-bind:class="errorMessages.flag ? 'invalid' : ''"></x-input>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <x-textarea id="description" name="description" rows="4" cols="5" placeholder="Description"></x-textarea>
                                    ...
                                    <x-input type="hidden" name="asset_warranty" value="{{ $asset->warranty_expiry_date }}"></x-input>
                                     @else
                                        ...
                                        <div class="form-group">
                                            ...
                                            <x-select id="asset" name="asset_id" x-bind:class="errorMessages.asset_id ? 'invalid' : ''">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @endphp
                                        <x-label for="assignee_user_id" required="true">Assigned Employee</x-label>
                                         <livewire:dynamic-dropdown
                                    ...
                                    <div class="form-group">
                                        ...
                                        <x-select id="qualification" name="qualification" placeholder="Assigned Employee" x-bind:class="errorMessages.qualification ? 'invalid' : ''">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <x-textarea id="additional_info" name="additional_info" rows="4" cols="5" placeholder="Additional Information"></x-textarea>
                                        <span class="invalid" x-text="errorMessages.additional_info"></span>
                                    </div>
                                    <div class="additional-task flex justify-between items-center">
                                        <h3>ADDITIONAL TASKS</h3> <a class="primary uppercase font-semibold" data-bs-toggle="offcanvas" data-bs-target="#add-additional-task"><em class="fa-solid fa-plus"></em>Add Task</a>
                                    </div>
                                    <hr>
                                        ...
                                        <template x-for="(task,index) in tasks" :key="index">
                                            <div class="flex justify-between mb-4 border-b pb-3">
                                               ...
                                               <div>
                                                    ...
                                                    <p class="gray1" x-text="task.task_detail"></p>
                                                    <label class="secondary mt-4" for="due_date">Due Date:</label>
                                                    <p class="primary" id="due_date" x-text="task.due_date"></p>
                                                </div>
                                                <div class="ml-4">
