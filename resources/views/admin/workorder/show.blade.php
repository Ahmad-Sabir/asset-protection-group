<x-app-layout>
    ...
    <div class="main-wrap" x-data="TaskData()">
        ...
        <div class="main-fixed-wrap md:mt-0 mt-[3.5rem]">
            ...
            <div class="top-buttons gap-3">
                <a class="md:w-auto w-full" href="{{ route('admin.work-orders.export.pdf', [$workOrder->id]) }}">
                    <x-button type="submit" class="btn-outline-secondary">
                        <em class="fa-solid fa-cloud-arrow-down"></em> Download PDF
                    </x-button>
                </a>
                <a class="md:w-auto w-full" href="{{ route('admin.work-orders.export.csv', [$workOrder->id]) }}">
                    ...
                    <div class="main-wrapper">
                        <div class="sm:flex items-center">
                            ...
                            <div class="sm:ml-auto gray1">
                                <a href="{{ route('admin.work-orders.edit', $workOrder->id) }}">Edit Details <em class="fa-solid fa-pen ml-2"></em></a>
                            </div>
                        </div>
                        ...
                        <div class="sm:flex items-center my-3">
                            ...
                            <div class="sm:ml-auto gray1">
                                <div class="popover-box" @if($workOrder->work_order_status == 'Completed') style="pointer-events: none" @else @endif>
    ...
    ?>
    @include('custom-view-js', ['work_order_base_url' => route('admin.work-orders.index')]);
   </x-app-layout>
