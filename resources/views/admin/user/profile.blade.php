        ...
        <div class="main-content">
            <div class="main-wrapper">
                <div class="admin-tabs">
                    ...
                    <form action="{{ route('admin.update-profile', $user->id) }}" method="put" x-data="submitForm()"
                        @submit.prevent="onSubmitPut" id="profile-post-form">
                        <div class="tab-content relative" id="tabs-tabContent">
                            <div class="md:absolute relative md:top-10 md:right-5">
                                <x-nav-link href="{{ route('admin.get-profile', ['is_edit' => request()->get('is_edit') ? false : true]) }}" class="btn btn-primary anchor-btn w-full-btn">
